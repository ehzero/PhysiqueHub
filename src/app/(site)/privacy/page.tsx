  ...
  return (
    ...
    >
      ...
      <article>
        ...
        <ul>
          <li>문의 시: 이름 또는 단체명, 이메일 주소, 문의 내용</li>
      ...
      <article>
        <h2>3. 보유 및 이용 기간</h2>
        <p>
          문의 내용은 답변과 후속 처리에 필요한 기간 동안 보관한 뒤 삭제합니다.
          접속 로그와 오류 로그는 보안 및 장애 대응 목적에 필요한 기간 동안
          보관할 수 있습니다. 법령에 따라 보존이 필요한 정보는 해당 기간 동안
          보관합니다.
        </p>
      </article>
      ...
      <article>
        ...
        <p>
          ...
          수 있습니다. 요청은 이메일로 접수할 수 있으며, 본인 확인이
          필요한 경우 추가 정보를 요청할 수 있습니다.
        </p>
      </article>
