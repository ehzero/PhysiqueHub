...
function cleanFilters(filters: Filters): Filters {
  return {
    ...
    ageGroups: cleanList(filters.ageGroups),
    experienceClasses: cleanList(filters.experienceClasses),
    measurementClasses: cleanList(filters.measurementClasses),
    classTexts: cleanList(filters.classTexts),
